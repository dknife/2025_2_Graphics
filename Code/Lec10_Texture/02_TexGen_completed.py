...
def initialize(window):
    ...
    mymesh.loadMesh("./Lec10_Texture/cow.txt")
    ...
    data0, w0, h0 = loadTextureImage('./Lec10_Texture/spheremap.png')
    texture0 = upload_texture(data0, w0, h0, texture_unit=0)

    data1, w1, h1 = loadTextureImage('./Lec10_Texture/spheremap.png')
    texture1 = upload_texture(data1, w1, h1, texture_unit=1)
    
    data2, w2, h2 = loadTextureImage('./Lec10_Texture/spheremap.png')
    texture2 = upload_texture(data2, w2, h2, texture_unit=2)
